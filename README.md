...
以上配置都可以在[chrome++.ini](https://github.com/wuyang9473/Google-Chrome-Portable/blob/main/chrome%2B%2B.ini)中进行修改.

# 获取

全自动无人管理项目，每周定时拉取最新Chrome离线包，并封装为便携版。

采用GitHub Actions自动编译发布，下载地址：[Google-Chrome-Stable-Portable](https://nightly.link/wuyang9473/Google-Chrome-Portable/workflows/build/main)
